...
class DigitalOceanProvider
{
    ...
    .catch(err => console.log(`dropletInfo: ${err}`));
      ...
      let v4networks = droplet.networks.v4;
      if (v4networks.length > 0) {
        console.log(`droplet ${id} ip: ${v4networks[0].ip_address}`);
      }
		}
	}
    ...
    .catch(err => console.log(`deleteDroplet: ${err}`));
